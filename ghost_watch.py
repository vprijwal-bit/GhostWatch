...
def is_sensitive_file(filepath):
    ...
    # Only monitor selected directories
    if not any(
        filepath == directory
    ...
    # ========================================================
    # HIGH-VALUE SENSITIVE FILE NAMES
    # ========================================================
    ...
    if filename in browser_sensitive_files:
        return True
    ...
    # ========================================================
    # Normal Firefox/SQLite files are NOT sensitive
    # by extension alone.
    # ========================================================
...
def get_risk_level(
    ...
    # ========================================================
    # 1. CRITICAL — Known dangerous processes
    # ========================================================
    ...
    if name in DANGEROUS_PROCESSES:
        ...
        return (
            "🔴 CRITICAL",
            f"Dangerous process '{process_name}' "
            "accessed a sensitive file"
        )

    # ========================================================
    # 2. CRITICAL — Network/data-transfer utilities
    # ========================================================
    ...
    if name in {
        ...
        return (
            "🔴 CRITICAL",
            f"Network utility '{process_name}' "
            "accessed a sensitive file"
        )

    # ========================================================
    # 3. CRITICAL — High-value credential files
    # ========================================================
    ...
    if filepath_lower in high_value_files:

        if name not in SAFE_PROCESSES:

            return (
                "🔴 CRITICAL",
                f"Sensitive credential file accessed "
                f"by '{process_name}'"
            )

    # ========================================================
    # 4. SUSPICIOUS — Command-line readers
    # ========================================================
    ...
    if name in {
        ...
        if "W" in action:
            ...
            return (
                "🟠 SUSPICIOUS",
                f"Command-line process '{process_name}' "
                "modified a sensitive file"
            )

    # ========================================================
    # 5. SUSPICIOUS — Shell processes
    # ========================================================
    ...
    # ========================================================
    # 6. SUSPICIOUS — Scripting languages
    # ========================================================
    ...
    # ========================================================
    # 8. UNKNOWN — Process not classified
    # ========================================================
